...
interface LostMaryDura35KProps {
  products: Product[];
  hideHeader?: boolean;
}

const LostMaryDura35K = ({ products, hideHeader = false }: LostMaryDura35KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">LOST MARY DURA 35K</h2>
...
export default LostMaryDura35K;
