...
interface LostMaryMO20KMegaProps {
  products: Product[];
  hideHeader?: boolean;
}

const LostMaryMO20KMega = ({ products, hideHeader = false }: LostMaryMO20KMegaProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">LOST MARY MO 20K MEGA</h2>
...
export default LostMaryMO20KMega;
