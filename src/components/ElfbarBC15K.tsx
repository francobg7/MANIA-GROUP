...
interface ElfbarBC15KProps {
  products: Product[];
  hideHeader?: boolean;
}

const ElfbarBC15K = ({ products, hideHeader = false }: ElfbarBC15KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">ELFBAR BC 15K</h2>
