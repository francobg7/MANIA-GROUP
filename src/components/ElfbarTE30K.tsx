...
interface ElfbarTE30KProps {
  products: Product[];
  hideHeader?: boolean;
}

const ElfbarTE30K = ({ products, hideHeader = false }: ElfbarTE30KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">ELFBAR TE 30K</h2>
