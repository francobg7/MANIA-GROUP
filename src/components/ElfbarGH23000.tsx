...
interface ElfbarGH23000Props {
  products: Product[];
  hideHeader?: boolean;
}

const ElfbarGH23000 = ({ products, hideHeader = false }: ElfbarGH23000Props) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">ELFBAR GH 23000</h2>
