...
interface IgniteV250Props {
  products: Product[];
  hideHeader?: boolean;
}

const IgniteV250 = ({ products, hideHeader = false }: IgniteV250Props) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">IGNITE V250</h2>
