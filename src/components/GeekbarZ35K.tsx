...
interface GeekbarZ35KProps {
  products: Product[];
  hideHeader?: boolean;
}

const GeekbarZ35K = ({ products, hideHeader = false }: GeekbarZ35KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">GEEKBAR Z35K</h2>
