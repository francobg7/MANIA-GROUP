...
interface LostMaryMixer30KProps {
  products: Product[];
  hideHeader?: boolean;
}

const LostMaryMixer30K = ({ products, hideHeader = false }: LostMaryMixer30KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">LOST MARY MIXER 30K</h2>
...
export default LostMaryMixer30K;
