...
interface IgniteV400Props {
  products: Product[];
  hideHeader?: boolean;
}

const IgniteV400 = ({ products, hideHeader = false }: IgniteV400Props) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">IGNITE V400</h2>
