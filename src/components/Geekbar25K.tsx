...
interface Geekbar25KProps {
  products: Product[];
  hideHeader?: boolean;
}

const Geekbar25K = ({ products, hideHeader = false }: Geekbar25KProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">GEEKBAR 25K</h2>
