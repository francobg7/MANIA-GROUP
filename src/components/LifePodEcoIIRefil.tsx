...
interface LifePodEcoIIRefilProps {
  products: Product[];
  hideHeader?: boolean;
}

const LifePodEcoIIRefil = ({ products, hideHeader = false }: LifePodEcoIIRefilProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">LIFE POD ECO II REFIL</h2>
...
export default LifePodEcoIIRefil;
