...
interface ElfbarBC20000KTouchProps {
  products: Product[];
  hideHeader?: boolean;
}

const ElfbarBC20000KTouch = ({ products, hideHeader = false }: ElfbarBC20000KTouchProps) => {
      ...
      {!hideHeader && (
        <>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-4">
            <h2 className="text-2xl md:text-3xl font-bold">ELFBAR BC 20000K TOUCH</h2>
...
export default ElfbarBC20000KTouch;
