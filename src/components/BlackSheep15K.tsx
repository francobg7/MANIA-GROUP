...
interface BlackSheep15KProps {
  products: Product[];
  hideHeader?: boolean;
}

const BlackSheep15K = ({ products, hideHeader = false }: BlackSheep15KProps) => {
    ...
    <section className={`w-full ${hideHeader ? '' : 'bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 mb-8'}`}>
      {!hideHeader && (
        <>
          ...
          <h2 className="text-2xl md:text-3xl font-bold">BLACK SHEEP 15K</h2>
